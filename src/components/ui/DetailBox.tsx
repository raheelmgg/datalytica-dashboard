...
function DetailBox({ kpi, tooltipMsg }: Props) {
  ...
  return (
    <div
      ...
      } w-full h-full flex flex-col gap-2.5 md:gap-5 items-center justify-center rounded-3xl px-1.5 py-3 text-white transition-shadow duration-300 cursor-pointer relative`}
    >
